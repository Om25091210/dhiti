...
public class champa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_champa, container, false);
        ...
        recyclerView=view.findViewById(R.id.rv_champa);
        ...
        proceed.setOnClickListener(v->{
            if(added_peoples_list.size()>1){
                ...
                args.putString("location","champa");
                    ...
                    if(snapshot.exists()){
                        for (DataSnapshot ds:snapshot.getChildren()){
                            if(snapshot.child(Objects.requireNonNull(ds.getKey())).child("city").exists()) {
                                if (Objects.equals(Objects.requireNonNull(snapshot.child(Objects.requireNonNull(ds.getKey())).child("city").getValue(String.class)).toLowerCase(), "janjgir-champa")) {
                        ...
                        memberAdapter=new memberAdpater(list,getContext(),"champa",mode_of_task,onclickInterface,onAgainClickInterface);
                        try {
                            recyclerView.setAdapter(memberAdapter);
                        } catch (Exception e) {
                            e.printStackTrace();
