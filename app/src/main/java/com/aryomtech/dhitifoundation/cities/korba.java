...
public class korba extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_korba, container, false);
        ...
        recyclerView=view.findViewById(R.id.rv_korba);
            ...
            users_ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                    ...
                    if(snapshot.exists()){
                        ...
                        memberAdapter=new memberAdpater(list,getContext(),"korba",mode_of_task,onclickInterface,onAgainClickInterface);
                        try {
                            recyclerView.setAdapter(memberAdapter);
                        } catch (Exception e) {
                            e.printStackTrace();
