package com.aryomtech.dhitifoundation.cities;
...
public class other extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        memberAdapter=new memberAdpater(list,getContext(),"bilaspur",mode_of_task,onclickInterface,onAgainClickInterface);
        try {
                    ...
                    if(snapshot.exists()){
                        for (DataSnapshot ds:snapshot.getChildren()){
                            if(snapshot.child(Objects.requireNonNull(ds.getKey())).child("city").exists()) {
                                if (!Objects.equals(Objects.requireNonNull(snapshot.child(Objects.requireNonNull(ds.getKey())).child("city").getValue(String.class)).toLowerCase(), "korba")
                                        && !Objects.equals(Objects.requireNonNull(snapshot.child(Objects.requireNonNull(ds.getKey())).child("city").getValue(String.class)).toLowerCase(), "janjgir-champa")
                                        && !Objects.equals(Objects.requireNonNull(snapshot.child(Objects.requireNonNull(ds.getKey())).child("city").getValue(String.class)).toLowerCase(), "bhilai")
                                        && !Objects.equals(Objects.requireNonNull(snapshot.child(Objects.requireNonNull(ds.getKey())).child("city").getValue(String.class)).toLowerCase(), "bilaspur")) {
                        ...
                        memberAdapter=new memberAdpater(list,getContext(),"other",mode_of_task,onclickInterface,onAgainClickInterface);
                        try {
                            recyclerView.setAdapter(memberAdapter);
                        } catch (Exception e) {
                            e.printStackTrace();
    ...
    private void Search(String s) {
        ...
        memberAdapter = new memberAdpater(mylist, getContext(), "bilaspur", mode_of_task, onclickInterface, onAgainClickInterface);
        try {
            recyclerView.setAdapter(memberAdapter);
        } catch (Exception e) {
            e.printStackTrace();
