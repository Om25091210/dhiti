...
public class bhilai extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_bhilai, container, false);
        ...
        recyclerView=view.findViewById(R.id.rv_bhilai);
        ...
        proceed.setOnClickListener(v->{
            if(added_peoples_list.size()>1){
                ...
                args.putString("location","bhilai");
            ...
            users_ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                    ...
                    if(snapshot.exists()){
                        ...
                        memberAdapter=new memberAdpater(list,getContext(),"bhilai",mode_of_task,onclickInterface,onAgainClickInterface);
                        try {
                            recyclerView.setAdapter(memberAdapter);
                        } catch (Exception e) {
                            e.printStackTrace();
