...
public class CreateNoteActivity extends AppCompatActivity {
    ...
    public void initMiscellaneous(){
        ...
        final ColorSeekBar colorSeekBar = layoutMiscellaneous.findViewById(R.id.colorSlider);
        ...
        colorSeekBar.setOnColorChangeListener((colorBarPosition, alphaBarPosition, color) -> {
            selectedNoteColor = "#" + Integer.toHexString(color).substring(2);
            imageColor1.setImageResource(0);
            imageColor2.setImageResource(0);
            imageColor3.setImageResource(0);
            imageColor4.setImageResource(0);
    ...
    private void showDeleteNoteDialog() {
        if (dialogDeleteNote == null){
            ...
            View view = LayoutInflater.from(this).inflate(R.layout.layout_delete_note, findViewById(R.id.layoutDeleteNoteContainer), false);
