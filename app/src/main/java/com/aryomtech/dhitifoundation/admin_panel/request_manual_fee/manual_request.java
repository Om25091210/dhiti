...
public class manual_request extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_manual_request, container, false);
        ...
        ViewAdapter adapter = new ViewAdapter(((FragmentActivity) getContextNullSafety()).getSupportFragmentManager(), getLifecycle());
