...
public class bhi_pay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_bhi_pay, container, false);
            ...
            users_ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                    ...
                    if(snapshot.exists()){
                        ...
                        memberAdapter=new memAdapter(list,getContext(),"bhilai",mode_of_task,onclickInterface,onAgainClickInterface);
                        try {
                            recyclerView.setAdapter(memberAdapter);
                        } catch (Exception e) {
                            e.printStackTrace();
